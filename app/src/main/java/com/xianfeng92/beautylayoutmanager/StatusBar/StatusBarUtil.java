package com.xianfeng92.beautylayoutmanager.StatusBar;
...
public class StatusBarUtil {
    ...
    /**
     * 修改状态栏和导航栏透明，支持4.4以上版本
     *
     */

    public static void setStatusBarAndNavigationBarTranslucent(Activity activity){
        //当FitsSystemWindows设置 true 时，会在屏幕最上方预留出状态栏高度的 padding
        StatusBarUtil.setRootViewFitsSystemWindows(activity,false);
        //设置状态栏透明
        StatusBarUtil.setTranslucentStatus(activity);
        StatusBarUtil.setTranslucentNavigationBar(activity);
